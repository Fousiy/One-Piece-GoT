...
void PhaseIVRandomizer()
{
  shuffleArray(PhaseIVarray);
}

void PhaseIVReshuffler()
{
  use1 = false;
  use2 = false;
  use3 = false;
...
void ContinentRandomizer()
{
  shuffleArray(Continentarray);
}

void ContinentReshuffler()
{
  us1 = false;
  us2 = false;
  us3 = false;
